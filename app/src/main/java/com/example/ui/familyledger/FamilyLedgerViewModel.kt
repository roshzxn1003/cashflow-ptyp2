...
class FamilyLedgerViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val currentUserId: String
        get() = authService.currentUser.value?.id ?: prefs.getString("user_email", null) ?: prefs.getString("local_user_id", null) ?: run {
    ...
    val currentUserName: String
        get() = prefs.getString("user_name", null) ?: authService.currentUser.value?.email?.substringBefore("@") ?: "You"

    private val _activeFamilyId = MutableStateFlow(
        prefs.getString("active_family_id", null) ?: "00000000-0000-0000-0000-000000000001"
    )
    ...
    init {
        ...
        viewModelScope.launch {
            ...
            if (currentPref == null || currentPref == "00000000-0000-0000-0000-000000000001") {
